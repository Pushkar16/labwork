...
public:
	...
	int JXYZ[3];
public:
	CTFFind(char FILEIN[200],char FILEOUT[200],float CS,float KV,float WGH,float XMAG,float DSTEP,float RESMIN,float RESMAX,
            float DFMIN,float DFMAX,float FSTEP,float DAST,int Box);
